      ...
      <Box sx={{ bgcolor: "#000000", p: 2 }}>
        ...
        >
          ...
          <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
            ...
            >
              บริการเช่ารถระดับพรีเมียม
              พร้อมให้คุณสัมผัสประสบการณ์การเดินทางที่เหนือชั้น
              ไม่ว่าคุณจะเดินทางไปไหน
              เราพร้อมเสมอที่จะให้คุณขับเคลื่อนด้วยความสะดวกสบายและปลอดภัย
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
            ...
            <Typography
              variant="body1"
              sx={{ textAlign: "left", lineHeight: 1.6, mb: "5px" }}
            >
              หน้าหลัก
            </Typography>
            <Typography
          ...
          <Grid item xs={12} sm={12} md={6} lg={3} xl={3}>
            ...
            <Box
              sx={{ display: "flex", alignItems: "center", gap: 1, mb: "5px" }}
            >
              <img
                src={location}
                alt="Icon"
